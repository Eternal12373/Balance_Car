...
static void chassis_no_follow_gimbal_control(chassis_move_t *chassis_move_rc_to_vector);
...
void chassis_behaviour_control_set(chassis_move_t *chassis_move_rc_to_vector)
{
  ...
  {
    chassis_no_follow_gimbal_control(chassis_move_rc_to_vector);
  }
}
...
static void chassis_no_follow_gimbal_control(chassis_move_t *chassis_move_rc_to_vector)
{
  ...
  chassis_move_rc_to_vector->vx_set = chassis_move_rc_to_vector->chassis_RC->rc.ch[CHASSIS_X_CHANNEL] * CHASSIS_OPEN_RC_SCALE;
  return;
}
