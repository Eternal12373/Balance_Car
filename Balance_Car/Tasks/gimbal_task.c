...
static void gimbal_init(gimbal_control_t *init)
{
    ...
    PID_init(&init->gimbal_yaw_motor.gimbal_motor_gyro_pid, YAW_SPEED_PID_KP,YAW_SPEED_PID_KI,YAW_SPEED_PID_KD,YAW_SPEED_PID_MAX_OUT, YAW_SPEED_PID_MAX_IOUT);
    //初始化pitch电机pid
    ...
    PID_init(&init->gimbal_pitch_motor.gimbal_motor_gyro_pid, PITCH_SPEED_PID_KP,PITCH_SPEED_PID_KI,PITCH_SPEED_PID_KD, PITCH_SPEED_PID_MAX_OUT, PITCH_SPEED_PID_MAX_IOUT);
